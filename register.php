...
<meta charset="UTF-8">
    ...
    <title>Techshiil Login Page</title>
    <!-- CUSTOM STYLESHEET -->
...
<section class="form__section">
    <div class="container form__section-container">
        ...
        <?php endif ?>
        <form action="<?= ROOT_URL ?>subscriber-register-logic.php" enctype="multipart/form-data" method="POST">
            ...
            <small>Already have an account? <a href="subscriber-login.php">Sign in</a></small>
        </form>
    </div>
</section>
